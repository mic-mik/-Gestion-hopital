...
const AddInfirmier = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:50476/api/infirmiers', {
                infirmier: newInfirmier,
                idDepartement: idDepartement
            });
            ...
            console.error("Il y a eu une erreur lors de la création de l'infirmier !", error);
